...
<div class="min-h-screen">
	<section>
		...
		<p>
			Picsel is licensed to You (End-User) by Weet UG (haftungsbeschränkt), located and
			registered at Edensbach 146, 88289 Waldburg, Germany (‘Licensor‘), for use only under the
		...
		<p>
			...
			this Licence Agreement. App Store and Play Store are referred to in this Licence Agreement as
			Services.
		</p>
		<p>
			The parties of this Licence Agreement acknowledge that the Services are not a Party to
			this Licence Agreement and are not bound by any provisions or obligations with regard to the
			Licensed Application, such as warranty, liability, maintenance and support thereof. Weet UG
			(haftungsbeschränkt), not the Services, is solely responsible for the Licensed Application and
			the content thereof.
		</p>
		<p>
			This Licence Agreement may not provide for usage rules for the Licensed Application that are
			in conflict with the latest <a
			...
			</a>  (‘Usage Rules‘). Weet UG (haftungsbeschränkt) acknowledges that it had the opportunity to
			review the Usage Rules and this Licence Agreement is not conflicting with them.
		</p>
		<p>
			Picsel when purchased or downloaded through the Services, is licensed to You for use only under
			the terms of this Licence Agreement. The Licensor reserves all rights not expressly granted to
			You. Picsel is to be used on devices that operate with Apple’s operating systems (‘iOS’ and ‘Mac
		...
		<ul>
			<li>
				1.1 Picsel(‘Licensed Application‘) is a piece of software created to enable users to upload and connect pictures in an simple and efficient way and 
                for being used on for iOS and Android mobile devices (‘Devices‘).
			</li>
		</ul>
		<h2>2. Scope of Licence</h2>
		<ul>
			<li>
				2.1  You are given a non-transferable, non-exclusive, non-sublicensable licence to install
			...
			<li>
				...
				separate licence is provided for such update, in which case the terms of that
				new licence will govern.
			</li>
			<li>
				2.3  You may not share or make the Licensed Application available to third parties (unless
				to the degree allowed by the Usage Rules, and with Weet UG (haftungsbeschränkt)’s prior
			...
			<li>
				...
				source code of the Licensed Application, or any part thereof (except with Weet UG
				(haftungsbeschränkt)’s prior written consent).
			</li>
			<li>
				...
				this licence, the Usage Rules, and any other terms and conditions that apply to the device
				or software used. You may not remove any intellectual property notices. You acknowledge that
				no unauthorised third parties may gain access to these copies at any time. If you sell your
			...
			<li>2.7  Licensor reserves the right to modify the terms and conditions of licensing</li>
			<li>
				2.8  Nothing in this licence should be interpreted to restrict third-party terms. When using
				the Licensed Application, You must ensure that You comply with applicable third-party terms
				and conditions.
			</li>
		</ul>
		...
		<ul>
			...
			<li>
				Store or Play Store Overview for this Licensed Application. 4.2  Weet UG
				(haftungsbeschränkt) and the End-User acknowledge that the Services have no obligation
		...
		<p>
			...
			product support, facilitate the software updates, and for purposes of providing other services
			to you (if any) related to the Licensed Application. Licensor may also use this information to
			improve its products or to provide services or technologies to you, as long as it is in a form
		...
		<ol>
			...
			<li>
				...
				and permissions to use and to authorise us, the Licensed Application, and other users of the
				Licensed Application to use your Contributions in any manner contemplated by the Licensed
			...
			<li>
				...
				manner contemplated by the Licensed Application and this Licence Agreement.
			</li>
		...
		<p>
			...
			this Licence Agreement and may result in, among other things, termination or suspension of
		...
		<p>
			...
			and licence to host, use copy, reproduce, disclose, sell, resell, publish, broad cast,
			retitle, archive, store, cache, publicly display, reformat, translate, transmit, excerpt (in
			whole or in part), and distribute such Contributions (including, without limitation, your
			...
			and authorise sublicences of the foregoing. The use and distribution may occur in any media
		...
		<p>
			...
			limitation mentioned above does not apply to injuries to life, limb, or health.
		</p>
		<h2>9. Warranaty</h2>
		<p>
		...
		<p>
			...
			device, that has been unauthorisedly modified, handled inappropriately or culpably, combined
			or installed with inappropriate hardware or software, used with inappropriate accessories,
			regardless if by Yourself or by third parties, or if there are any other reasons outside
			of Weet UG (haftungsbeschränkt)’s sphere of influence that affect the executability of the
			Licensed Application.
		</p>
		<p>
			9.3  You are required to inspect the Licensed Application immediately after installing it and
			notify Weet UG (haftungsbeschränkt) about issues discovered without delay by email provided
			in Product Claims. The defect report will be taken into consideration and further investigated
			if it has been emailed within a period of fourteen (14) days after discovery.
		</p>
		<p>
			9.4  If we confirm that the Licensed Application is defective, Weet UG
			(haftungsbeschränkt) reserves a choice to remedy the situation either by means of solving the
		...
		<p>
			...
			period of limitation amounting to twelve (12) months after the Licensed Application was made
			available to the user. The statutory periods of limitation given by law apply for users who
			are consumers.
		</p>
		<h2>10. Product Claims</h2>
		<p>
			Weet UG (haftungsbeschränkt) and the End-User acknowledge that Weet UG (haftungsbeschränkt),
			and not the Services, is responsible for addressing any claims of the End-User or any third
			party relating to the Licensed Application or the End-User’s possession and/or use of that
			Licensed Application, including, but not limited to:
		</p>
		<ol>
			<li>product liability claims;</li>
			<li>
				any claim that the Licensed Application fails to conform to any applicable legal or
		...
		<p>Weet UG<br />Edensbach 146<br />88289 Waldburg <br />Germany</p>
		<p>Vertretungsberechtigte Personen: Otto Dämpfle</p>
		<p>E-Mail-Adresse: <a href="mailto:info@weetapp.de"> info@weetapp.de</a></p>
		<h2>13. Termination</h2>
		<p>
			The licence is valid until terminated by Weet UG (haftungsbeschränkt) or by You. Your rights
			under this licence will terminate automatically and without notice from Weet UG
			(haftungsbeschränkt) if You fail to adhere to any term(s) of this licence.
		...
		<h2>14. Thrid-Party Terms of Agreements and Beneficiary</h2>
		<p>
			Weet UG (haftungsbeschränkt) represents and warrants that Weet UG (haftungsbeschränkt) will
			comply with applicable third-party terms of agreement when using Licensed Application. In
			Accordance with Section 9 of the ‘Instructions for Minimum Terms of Developer’s End-User
			Licence Agreement’, both Apple and Google and their subsidiaries shall be third-party
			beneficiaries of this End User Licence Agreement and — upon Your acceptance of the terms and
			conditions of this Licence Agreement, both Apple and Google will have the right (and will be
			deemed to have accepted the right) to enforce this End User Licence Agreement against You as a
			third-party beneficiary thereof.
		</p>
		<h2>15. Itellectual Property Rights</h2>
		<p>
			Weet UG (haftungsbeschränkt) and the End-User acknowledge that, in the event of any
			third-party claim that the Licensed Application or the End-User’s possession and use of that
			Licensed Application infringes on the third party’s intellectual property rights, Weet UG
			(haftungsbeschränkt), and not the Services, will be solely responsible for the
			investigation, defence, settlement, and discharge or any such intellectual property
			infringement claims.
		</p>
		<h2>16. Applicable Law</h2>
		<p>
			This Licence Agreement is governed by the laws of Germany excluding its conflicts of law
			rules.
		</p>
		...
		<p class="lastP">Last updated  December 3, 2022</p>
	</section>
</div>
